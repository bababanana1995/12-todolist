...
const Comp = props => {
  _s();
  let [title, setTitle] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
  let [error, setError] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("Title is required");
  const addItem = () => {
    if (title.trim() !== "") {
      props.addItem(title);
      setTitle("");
...
//# sourceMappingURL=stories-AddItimForm-stories.4832141b7dae46e5e03e.hot-update.js.map